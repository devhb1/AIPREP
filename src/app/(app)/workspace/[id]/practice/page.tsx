  ...
  return (
    <main className="mx-auto max-w-4xl space-y-6">
      <div>
        ...
        <h2 className="mt-2 text-4xl text-ink">Practice</h2>
        <p className="mt-2 text-sm text-muted">
          Grounded MCQs from trusted memory + documents. Mistakes create remediation
          tasks.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Link
          href={`/workspace/${workspaceId}/mistakes`}
      ...
      <section className="space-y-4">
        {questions.length === 0 ? (
          ...
          questions.map((q) => (
            <article key={q.id} className="rounded-2xl border border-line bg-panel p-5 space-y-3">
